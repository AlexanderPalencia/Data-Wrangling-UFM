...
Devolucion <- Clientes[7]
DfDevolucion <- filter(data, CLIENTE == Devolucion)
nrow(DfDevolucion)
summary(DfDevolucion)
## Se llego a devolver hasta 1985.0 en cantidad un precio de 496.2 Luis Jaime Urbano Piloto con mas entrega 22 en total.
```
